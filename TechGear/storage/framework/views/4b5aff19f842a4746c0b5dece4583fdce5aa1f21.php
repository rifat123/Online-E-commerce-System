		...
		<div class="col-5">
			...
			<?php 
	      	...
	      	<div class="clearfix mt-2 mb-3">	      		
	      		<a href="/user/address-book/check/<?php echo e($ua->id); ?>" class="btn btn-info float-left btn-sm text-white">Edit This Address</a>
	      		<a href="/user/add-address/check" class="btn btn-info float-right btn-sm text-white">Add New Address</a>	      		
	      	</div>
	      	<input type="hidden" name="address" value="<?php echo e($ua->id); ?>">
