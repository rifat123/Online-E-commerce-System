...
<?php $__env->startSection('middle'); ?>
	...
	<div class="container text-white mt-4 border border-info rounded-top border-bottom-0">
		<div class="row">			
			...
			<div class="col-sm-3">
				Child Catagory <input type="text" class="form-control form-control-sm" name="table_name" value="<?php echo e(ucwords($tab)); ?>" readonly>
			</div>
			<div class="col-sm-2">
	...
	<div class="container mb-2 border border-info rounded-bottom border-top-0">		
		...
		<div class="row">
			<div class="col-3 mt-3">
				<input type="text" class="form-control form-control-sm bg-info text-white border-info" maxlength=20 name="<?php echo e('column_name'.$i); ?>" placeholder="Property-<?php echo e($i); ?>" required>
			</div>
			<div class="col-5 mt-3">				
				<input type="radio" class="ml-2" name="<?php echo e('column_type'.$i); ?>" value="text" checked>Text
				<input type="radio" class="ml-2" name="<?php echo e('column_type'.$i); ?>" value="number">Number
				<i class="ml-2 fas fa-ellipsis-v"></i>
				<input type="checkbox" class="ml-2" name="<?php echo e('required'.$i); ?>" value="required">Must Fillup
				<i class="ml-2 fas fa-ellipsis-v"></i>
				<input type="checkbox" class="ml-2" name="<?php echo e('filter'.$i); ?>" value="filter">Use as Filter
			</div>
			<div class="col-4 mt-3">
				<input type="text" class="form-control form-control-sm bg-info text-white border-info" name="<?php echo e('dummy_data'.$i); ?>" maxlength=150 placeholder="Dummy Data" required>
			</div>			
		</div>
		<?php endfor; ?>
		<input type="hidden" id="temp" name="loopCount" value=<?php echo e($np+1); ?>>
